...
- utiliser la fonction `persist` de Zustand pour faire persister les données dans `localstorage` 
...
React Query (now known as TanStack React Query) simplifies data fetching and state management in your React applications.  
...
- pour cela, utiliser TanStack Query (useMutation) et ne plus utiliser useEffect
